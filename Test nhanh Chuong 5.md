...
**Họ và tên:** Đinh Như Tuấn Hải 
**Mã sinh viên:** 2451271108
**Lớp:** 66anm2
...
JavaScript là ngôn ngữ lập trình dùng để tạo tương tác và xử lý logic trên trang web. Nó chạy chủ yếu trên trình duyệt hoặc môi trường server
...
- CSS: tạo giao diện và kiểu dáng  
...
- Kết quả: numberstringbooleanobjectobject [web:58][web:42]
...
Khi một điều kiện đúng, các nhánh sau không được kiểm tra nữa.
...
constructor dùng để khởi tạo giá trị ban đầu cho object khi tạo instance mới.
...
Prototype là cơ chế cho phép object kế thừa thuộc tính và phương thức từ object khác. Khi truy cập thuộc tính không có trong object, JavaScript sẽ tìm trong prototype chain.
...
Tạo object mới và kế thừa từ personPrototype.
---
